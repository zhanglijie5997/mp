            ...
            child: Column(
              children: [
                    ...
                    Expanded(
                      child: Obx(
                        () => TabBar(
                            ...
                            tabs: controller.marketTabList
                                .mapIndexed((index, element) => Container(
                                    padding: const EdgeInsets.symmetric(
                                        vertical: 5, horizontal: 10),
                                    decoration: BoxDecoration(
                                      color: controller.marketTabSelect.value !=
                                              index
                ...
                Expanded(
                    child: TabBarView(
                  controller: controller.marketTabController,
                  children: controller.marketTabList
                      .map((element) => MarketTabPageView())
                      .toList(),
                ))
              ],
            ),

...
class AnnouncementController extends GetxController
  ...
  getTabListData() async {
    final res =
        await HomeRequest.apiAnnouncementTypeSelectAnnouncementTypeList();
    if (res.data?.data != null) {
      res.data!.data!.insert(0, const Datum(name: "全部", id: ""));
    }
    tabData.value = res.data!;
    tabController =
        TabController(length: tabData.value.data?.length ?? 0, vsync: this)

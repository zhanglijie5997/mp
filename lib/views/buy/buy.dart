                      ...
                      child:Column(
                        ...
                        children: [
                          Row(
                              children: [
                                Expanded(
                                  child: Text("测试一号测试一号测试一号测试一号测试一号测试一号测试一号测试一号测试一号", style: context.textTheme.bodyMedium?.copyWith(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius: 6.radius,
                                        border: Border.all(
                                          width: 1, color: context.customTheme?.gray3 ?? Colors.white
                                        )
                                      ),
                                      child: Center(
                                        child: SvgPicture.asset(
                                          Assets.assetsImagesSvgIconIconIconCut,
                                          width: 20, height: 20,
                                    ...
                                    Padding(
                                      ...
                                      child: Obx(
                                        () => Text("${controller.number.value}", style: context.textTheme.bodyMedium?.copyWith(
                                ...
                                // 单价
                                Text("单价: ¥100", style: context.textTheme.bodyMedium?.copyWith(
                                  color: context.customTheme?.gray3, fontWeight: FontWeight.bold
                                ))
                              ],
                            ),
                          )
                ...
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: Obx(
                        () => Text("总价 ¥${controller.number.value * 100}", style: context.textTheme.bodyMedium?.copyWith(
